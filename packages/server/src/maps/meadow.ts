 ...
 * Here there is nowhere to funnel anyone, and the only cover is scattered woods
 * and the hill -- which makes it the board for finding out what the units do
 * when the terrain stops doing it for them.
 *
